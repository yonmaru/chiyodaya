...
$site_top = "https://chiyodaya.jp/";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "info@chiyodaya.jp";
...
$Referer_check_domain = "chiyodaya.jp";
...
$thanksPage = "https://chiyodaya.jp/inquiry/thanks.html";
...
$require = array('ご用件','お名前','ふりがな','Email');
...
この度は千代田屋にお問い合わせをいただきましてありがとうございます。
担当者より、後日ご登録いただきましたメールもしくはお電話にご連絡いたします。

もしご連絡がない場合、お問い合わせがうまくできていない可能性がございますので、
お手数ですが、再度ご連絡ください。
